DROP TABLE IF EXISTS dump_os_task
GO
...
CREATE CLUSTERED COLUMNSTORE INDEX CCIX_os_task_dump ON dump_os_task
CREATE INDEX CIX_os_task_dump_collect_date ON dump_os_task (collect_date) WITH (DATA_COMPRESSION=PAGE)
